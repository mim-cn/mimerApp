...
import com.mim.mimer.main.PageManager;
            ...
            public void handleMessage(Message msg) {
                ...
                switch (msg.what) {
                    case Constant.CONN_SERVER_OK:
                        ...
                        Intent intent = new Intent(loginActivity.this, PageManager.class);
                        startActivity(intent);
                        loginActivity.this.finish();
                        break;
                    case Constant.CONN_SERVER_ERROR:
                        Toast.makeText(getApplicationContext(), "连接服务器失败！", Toast.LENGTH_SHORT).show();
                        Intent intentError = new Intent(loginActivity.this, PageManager.class);
        ...
        if (sender == null) {
            Thread thread = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    sender.AttachLoginer(loginActivity.this);
