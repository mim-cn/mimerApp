...
public class ContactPage extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (mView == null) {
            mView = inflater.inflate(R.layout.contact_page, null);
            //初始化数据
            initData();
...
//        item_icon.setImageDrawable(getResources().getDrawable((R.drawable.group)));
    ...
    private void initData() {
        ...
        ItemView cb0 = new ItemView("群1", "123");
        ItemView cb1 = new ItemView("群2", "123");
        ItemView cb2 = new ItemView("群3", "123");
        list.add(cb0);
        list.add(cb1);
        list.add(cb2);
    }
